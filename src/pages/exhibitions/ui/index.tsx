  ...
  return (
    <PageWrapper>
      ...
      <div className={styles.topLine}>
        <div className={styles.topLineCategory}>{t("exhibitions.preview")}</div>
        <div className={styles.topLineCategory}>
          {t("exhibitions.itemTitle")}
        </div>
        <div className={styles.topLineCategory}>{t("exhibitions.address")}</div>
        <div className={styles.topLineCategory}>{t("exhibitions.price")}</div>
